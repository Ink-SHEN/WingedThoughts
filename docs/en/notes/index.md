...
A collection of my learning notes and thoughts.
...
<div class="note-cards">
  ...
  <a class="note-card" href="./linear-algebra">
    <span class="note-card-glyph">∑</span>
    <span class="note-card-body">
      <span class="note-card-title">Linear Algebra</span>
      <span class="note-card-desc">The language of vectors, matrices and spaces</span>
    </span>
    <span class="note-card-arrow">→</span>
  </a>
